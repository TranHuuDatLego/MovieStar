    ...
    <section class="movie-detail">
      <div class="container">
        <figure class="movie-detail-banner">
          <!-- Đặt đường dẫn ảnh nếu có, thay thế bằng thuộc tính của movie -->
          <img src="./assets/images/movie-4.png" alt="${movie.name_movies} movie poster">
        ...
        <div class="movie-detail-content">
          ...
          <div class="meta-wrapper">
            ...
            <div class="ganre-wrapper">
              <!-- Giả sử thể loại là chuỗi cách nhau bởi dấu phẩy -->
              <c:forEach var="genre" items="${movie.genre.split(',')}">
                <a href="#">${genre.trim()},</a>
              </c:forEach>
            </div>
